...
const userService = require('./custom.service');
...
function create(req, res, next) {
    console.log(req.body.params.checkedFields)
    userService.create(req.body.params.org_id,req.body.params.warehouse,req.body.params.formData,req.body.params.checkedFields)
