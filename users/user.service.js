...
async function getByOrg_id(org_id) {
  return await db.User.findAll({  
    where: {  
     org_id: org_id,  
...
async function userCount(org_id) {
...
async function getWarehouseC(org_id) {  
  return await db.User.findAll({  
...
async function create(params) {
  // validate
    if (await db.User.findOne({ where: { email: params.email, org_id: params.org_id } })) {
  ...
  if (params.role == "Admin") {
    try {
      ...
      const mailOptions = {
        ...
        html: "<a href='www.stellium.com'><img src='https://www.stellium.com/wp-content/uploads/2016/03/01_Full-Color-Logo.png' width='30%' /></a><br><h3>Orgnization Id: "+ params.org_id +"</h3><h3>Username: " + params.user_id + "</h3><h3> Password: " + params.password + "</h3><h4>Thank you for connecting to <a href='www.stellium.com'>stellium</a></h4> <br><br>" , // HTML body
      };
